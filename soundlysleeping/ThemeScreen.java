...
public class ThemeScreen extends Activity {

	ArrayAdapter adapter;
	ImageView themeScreenPic;
	ListView themeScreenList;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		themeScreenPic = (ImageView)findViewById(R.id.themeScreenPic);
		themeScreenList = (ListView)findViewById(R.id.themeScreenList);
	...
	public void onConfigurationChanged(Configuration config){
		...
		setContentView(R.layout.theme_screen);					//automatically looks in layout-land if landscape?
	}
	...
	public void setupListView(){
		...
		themeScreenList.setAdapter(adapter);
		themeScreenList.setOnItemClickListener(new OnItemClickListener(){
